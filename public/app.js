...
const I18N={
  network_full:["Mạng lưới Giáo dục và Phát triển Cộng đồng Sky First","Sky First Education & Community Development Network"],
  nav_home:["Trang chủ","Home"], nav_register:["Đăng ký","Registration"], nav_classes:["Lớp học","Classes"],
  nav_activities:["Hoạt động","Activities"], nav_units:["Đơn vị","Units"], nav_news:["Tin tức","News"], nav_lookup:["Tra cứu","Lookup"],
  reg_overview:["Tổng quan đăng ký","Registration overview"],
  reg_overview_desc:["Biểu mẫu đang mở, điều kiện và quy trình tiếp nhận hồ sơ.","Open forms, eligibility requirements and application workflow."],
  reg_member:["Thành viên & Core Team","Members & Core Team"],
  reg_member_desc:["Đăng ký tham gia, theo dõi hồ sơ và thông tin nhân sự.","Apply to join and track membership or personnel records."],
  reg_volunteer:["Tình nguyện viên","Volunteers"],
  reg_volunteer_desc:["TNV chung, TNV dạy học và các vị trí chuyên môn phù hợp.","General, teaching and specialist volunteer opportunities."],
  class_list:["Danh sách lớp học","Class directory"],
  class_list_desc:["Theo dõi các lớp, chương trình giáo dục và tình trạng tuyển sinh.","Browse classes, education programs and enrollment status."],
  class_register:["Đăng ký lớp học","Class registration"],
  class_register_desc:["Gửi hồ sơ đăng ký học và nhận mã tra cứu trực tuyến.","Submit a class application and receive an online tracking code."],
  class_lookup:["Tra cứu hồ sơ học tập","Track class application"],
  class_lookup_desc:["Kiểm tra tình trạng hồ sơ đã gửi trên hệ thống.","Check the status of an application submitted to the system."],
  activity_list:["Hoạt động & Sự kiện","Activities & Events"],
  activity_list_desc:["Chương trình giáo dục, cộng đồng, tình nguyện và sự kiện của SFN.","SFN education, community, volunteer programs and events."],
  activity_register:["Đăng ký hoạt động","Activity registration"],
  activity_register_desc:["Đăng ký tham gia chương trình đang tiếp nhận hồ sơ.","Apply for programs currently accepting registrations."],
  activity_volunteer:["Cơ hội tình nguyện","Volunteer opportunities"],
  activity_volunteer_desc:["Tìm vị trí phù hợp và đồng hành cùng các chương trình cộng đồng.","Find a suitable role and contribute to community programs."],
  unit_list:["Đơn vị trực thuộc","Affiliated units"],
  unit_list_desc:["Thông tin các đơn vị, phạm vi hoạt động và đầu mối phụ trách.","Information on units, scope of work and responsible contacts."],
  unit_structure:["Cơ cấu Mạng lưới","Network structure"],
  unit_structure_desc:["Khám phá hệ thống đơn vị đang hoạt động trong Sky First Network.","Explore the units operating across Sky First Network."],
  lookup_record:["Tra cứu hồ sơ","Application lookup"],
  lookup_record_desc:["Kiểm tra trạng thái hồ sơ bằng mã hồ sơ và email đăng ký.","Check an application using its tracking code and registered email."],
  lookup_cert:["Xác thực GCN/GXN","Certificate verification"],
  lookup_cert_desc:["Kiểm tra tính xác thực của giấy chứng nhận và giấy xác nhận.","Verify certificates and confirmation letters issued by SFN."],
  footer_intro:["Kết nối giáo dục, tri thức và các hoạt động phát triển cộng đồng trên một hệ thống thống nhất.","Connecting education, knowledge and community development through one unified platform."],
  footer_quick:["Liên kết nhanh","Quick links"], footer_lookup:["Tra cứu & Hệ thống","Lookup & Systems"], footer_contact:["Thông tin liên hệ","Contact information"],
  portal_info:["Cổng Thông tin","Information Portal"], portal_academic:["Cổng Học liệu & Học thuật","Academic Hub"], portal_volunteer:["Cổng Tình nguyện viên","Volunteer Portal"],
  official_website:["Website chính thức","Official website"], contact_email:["Email liên hệ","Contact email"], support_email:["Email hỗ trợ","Support email"], phone_zalo:["Điện thoại/Zalo","Phone/Zalo"],
  copyright:["Bản quyền","Copyright"], privacy:["Quyền riêng tư","Privacy"], loading:["Đang tải Sky First Network…","Loading Sky First Network…"]
};

let currentLang=localStorage.getItem("sfn_lang")==="en"?"en":"vi";
document.title=currentLang==="en"?"Sky First Network — Member & Volunteer Portal":"Sky First Network — Cổng Thành viên & Tình nguyện viên";
const i18nIndex=Object.fromEntries(Object.values(I18N).flatMap(v=>[[v[0],v[1]],[v[1],v[1]]]));
const phrasePairs=Object.values(I18N).map(v=>[v[0],v[1]]);
const autoPairs=[
 ["Kết nối giáo dục. Phát triển cộng đồng.","Connecting education. Advancing communities."],
 ["Một cổng chung cho Thành viên, Core Team, Tình nguyện viên, Học sinh/Học viên, lớp học, hoạt động, hồ sơ, GCN/GXN và quản trị Sky First Network.","A unified platform for Members, Core Team, Volunteers, Students/Learners, classes, activities, applications, certificates and Sky First Network administration."],
 ["Kết nối tri thức – Lan tỏa giá trị – Kiến tạo tương lai.","Connect knowledge – Share values – Shape the future."],
 ["Đăng ký và theo dõi hồ sơ nhân sự.","Apply and track membership records."],["TNV chung và TNV dạy học theo phạm vi chuyên môn.","General and teaching volunteers by area of expertise."],
 ["Lớp 9–12, Cơ bản, Giao tiếp, IELTS.","Grades 9–12, Foundation, Communication and IELTS."],["Tra cứu giấy chứng nhận/giấy xác nhận.","Verify certificates and confirmation letters."],
 ["Đăng nhập","Sign in"],["Đăng nhập hệ thống","System sign in"],["Đăng ký tham gia","Join / Register"],["Mở","Open"],
 ["Truy cập nhanh","Quick access"],["Tin mới","Latest news"],["Chưa có tin.","No news yet."],["Đăng ký & Biểu mẫu","Registration & Forms"],
 ["Mỗi biểu mẫu có bộ câu hỏi, điều khoản, mã hồ sơ và quy trình xử lý riêng.","Each form has its own questions, terms, tracking code and processing workflow."],
 ["Mở biểu mẫu","Open form"],["Yêu cầu: từ đủ","Requirement: at least"],["tuổi","years old"],["-- Chọn --","-- Select --"],
 ["Tệp được lưu bảo mật trong hệ thống.","Files are stored securely in the system."],["Đang tải biểu mẫu…","Loading form…"],["← Quay lại","← Back"],
 ["Gửi hồ sơ","Submit application"],["Hủy","Cancel"],["Đang gửi…","Submitting…"],["Hồ sơ đã được tiếp nhận","Application received"],
 ["Mã hồ sơ:","Application code:"],["Hãy lưu mã này để tra cứu. Hệ thống cũng gửi email xác nhận nếu email gửi đi đã được cấu hình.","Keep this code for tracking. A confirmation email will also be sent when outbound email is configured."],
 ["Lớp học & Chương trình giáo dục","Classes & Education Programs"],["Đăng ký","Register"],["Chưa có lớp học.","No classes available."],
 ["Hoạt động & Sự kiện","Activities & Events"],["Chưa có sự kiện.","No events available."],["Đơn vị trực thuộc","Affiliated Units"],["Phụ trách:","Contact:"],
 ["Tin tức & Cập nhật","News & Updates"],["Tra cứu & Xác thực","Lookup & Verification"],["Tra cứu tình trạng hồ sơ hoặc xác thực GCN/GXN do Sky First phát hành.","Track an application or verify certificates/confirmation letters issued by Sky First."],
 ["Nhập mã hồ sơ và email đã sử dụng khi đăng ký.","Enter the application code and email used during registration."],["Mã hồ sơ","Application code"],["Email đã đăng ký","Registered email"],
 ["Đang tra cứu…","Searching…"],["Người đăng ký","Applicant"],["Biểu mẫu","Form"],["Trạng thái hồ sơ","Application status"],["Thời điểm tiếp nhận","Received at"],["Cập nhật gần nhất","Last updated"],
 ["Xác thực GCN/GXN","Verify certificate"],["Nhập mã được ghi trên Giấy chứng nhận hoặc Giấy xác nhận.","Enter the code shown on the Certificate or Confirmation Letter."],["Mã GCN/GXN","Certificate code"],["Xác thực","Verify"],["Đang xác thực…","Verifying…"],
 ["Loại văn bản","Document type"],["Người được cấp","Recipient"],["Đơn vị ghi nhận","Recognizing unit"],["Chương trình / Hoạt động","Program / Activity"],["Vai trò / Nội dung tham gia","Role / Participation"],["Nội dung được ghi nhận","Recognized content"],["Ngày cấp","Issue date"],
 ["Đăng nhập Sky First","Sky First Sign In"],["Chọn khu vực phù hợp. Quyền Thành viên và Quản trị viên chỉ do SFN cấp.","Choose the appropriate portal. Member and administrator access is granted only by SFN."],
 ["Bạn là Học sinh/Học viên?","Are you a Student/Learner?"],["Lớp học, hồ sơ, thông báo, GCN/GXN.","Classes, applications, notices and certificates."],
 ["Bạn là Thành viên?","Are you a Member?"],["Hồ sơ nhân sự, hoạt động, nhiệm vụ và thủ tục nội bộ.","Personnel records, activities, tasks and internal procedures."],
 ["Bạn là Quản trị viên?","Are you an Administrator?"],["Chỉ tài khoản đã được cấp quyền quản trị.","For accounts with administrative access only."],
 ["Học sinh/Học viên","Student/Learner"],["Thành viên","Member"],["Quản trị viên","Administrator"],["Tiếp tục với Google","Continue with Google"],
 ["Tạo tài khoản","Create account"],["Đăng xuất","Sign out"],["Trang chủ","Home"],["Tìm kiếm","Search"],["Lưu","Save"],["Sửa","Edit"],["Xóa","Delete"],["Thêm","Add"],["Đóng","Close"],
 ["Đang bật","Enabled"],["Đang tắt","Disabled"],["Bắt buộc","Required"],["Thông tin","Information"],["Họ và tên","Full name"],["Mô tả","Description"],
 ["Lớp học","Classes"],["Nhiệm vụ","Tasks"],["Điểm danh","Attendance"],["Có mặt","Present"],["Có phép","Excused"],["Vắng","Absent"],["Check-in thành công.","Check-in successful."],
 ["Hỗ trợ & Ticket","Support & Tickets"],["Mã","Code"],["Người gửi","Submitter"],["Loại","Type"],["Ưu tiên","Priority"],["Trạng thái","Status"],["Xử lý","Process"],
 ["Thấp","Low"],["Bình thường","Normal"],["Cao","High"],["Khẩn","Urgent"],["Mới","New"],["Đang xử lý","In progress"],["Chờ phản hồi","Awaiting response"],["Đã giải quyết","Resolved"],["Đã đóng","Closed"],
 ["File & Minh chứng","Files & Evidence"],["Tệp","File"],["Dung lượng","Size"],["Quyền","Access"],["Cho phép công khai","Allow public access"],
 ["Tổng quan","Overview"],["Trung tâm phê duyệt","Approval Center"],["Hồ sơ đăng ký","Applications"],["Tài khoản & Phân quyền","Accounts & Permissions"],["Hồ sơ nhân sự","Personnel Records"],
 ["Tuyển dụng & Đánh giá","Recruitment & Evaluation"],["Điều khoản & Chính sách","Terms & Policies"],["Phạm vi TNV Dạy học","Teaching Volunteer Scope"],["Lớp học & Điểm danh","Classes & Attendance"],
 ["Sự kiện & Check-in","Events & Check-in"],["Kho văn bản","Document Repository"],["Tin tức & CMS","News & CMS"],["Cài đặt","Settings"],["Sao lưu & Phục hồi","Backup & Restore"],
 ["Tạo biểu mẫu","Create form"],["Chỉnh biểu mẫu","Edit form"],["Tên biểu mẫu","Form name"],["Mã tiền tố","Code prefix"],["Câu hỏi","Question"],["Xóa phần","Delete section"],["Thêm phần","Add section"],["Lưu phiên bản mới","Save new version"],
 ["Đã lưu phiên bản biểu mẫu.","Form version saved."],["Đã tạo biểu mẫu.","Form created."],["Đã thêm.","Added."],["Đã cập nhật.","Updated."],["Đã xóa.","Deleted."],
 ["Đề nghị cấp","Request issuance"],["Quy trình:","Workflow:"],["Chưa cấp số","Number not assigned"],["Phát hành","Issue"],["Thu hồi","Revoke"],["Đề nghị cấp GCN/GXN","Certificate issuance request"],
 ["Thông tin dưới đây là dữ liệu chính thức dùng cho quy trình phê duyệt, phát hành và tra cứu GCN/GXN.","The information below is the official data used for certificate approval, issuance and verification."],
 ["Họ và tên người được cấp","Recipient full name"],["Chương trình / Hoạt động","Program / Activity"],["Vai trò / Tư cách tham gia","Role / Participation status"],["Gửi đề nghị cấp","Submit issuance request"],
 ["Đã phát hành:","Issued:"],["Lý do thu hồi:","Revocation reason:"],["Đã thu hồi.","Revoked."],["Phản hồi nội bộ","Internal response"],["Đã cập nhật ticket.","Ticket updated."],["Upload file","Upload file"],["Đã upload.","Uploaded."]
];

function translateExact(text){
  if(currentLang!=="en") return text;
  const trimmed=text.trim(); if(!trimmed) return text;
  const exact=i18nIndex[trimmed]||Object.fromEntries(autoPairs)[trimmed];
  if(exact) return text.replace(trimmed,exact);
  let out=text;
  for(const [vi,en] of [...phrasePairs,...autoPairs].sort((a,b)=>b[0].length-a[0].length)){
...
function translateTree(root=document.body){
  ...
  const tagged=[];
  if(scope.matches?.("[data-i18n]")) tagged.push(scope);
  tagged.push(...scope.querySelectorAll?.("[data-i18n]")||[]);
  tagged.forEach(el=>{const v=I18N[el.dataset.i18n];if(v){const next=v[currentLang==="en"?1:0];if(el.textContent!==next)el.textContent=next}});
  const walker=document.createTreeWalker(scope,NodeFilter.SHOW_TEXT,{acceptNode:n=>{
    const p=n.parentElement;if(!p||["SCRIPT","STYLE","TEXTAREA"].includes(p.tagName)||p.closest("[data-i18n]"))return NodeFilter.FILTER_REJECT;
    return /[A-Za-zÀ-ỹ]/.test(n.nodeValue||"")?NodeFilter.FILTER_ACCEPT:NodeFilter.FILTER_REJECT;
  }});
  const nodes=[];while(walker.nextNode())nodes.push(walker.currentNode);
  for(const n of nodes){const original=n.__sfnVi||n.nodeValue;n.__sfnVi=original;n.nodeValue=currentLang==="en"?translateExact(original):original}
  document.querySelectorAll("input[placeholder],textarea[placeholder],button[title]").forEach(el=>{
    for(const attr of ["placeholder","title"]){if(!el.hasAttribute(attr))continue;const key="sfn"+attr;const original=el.dataset[key]||el.getAttribute(attr);el.dataset[key]=original;el.setAttribute(attr,currentLang==="en"?translateExact(original):original)}
  });
  if(langBtn)langBtn.textContent=currentLang==="vi"?"EN":"VI";
}
function setLanguage(lang){currentLang=lang;localStorage.setItem("sfn_lang",lang);document.title=lang==="en"?"Sky First Network — Member & Volunteer Portal":"Sky First Network — Cổng Thành viên & Tình nguyện viên";translateTree(document.body);loadMe().catch(()=>{});}
if(langBtn)langBtn.onclick=()=>setLanguage(currentLang==="vi"?"en":"vi");
if(menuToggle){menuToggle.onclick=()=>{const open=mainNav.classList.toggle("open");menuToggle.setAttribute("aria-expanded",String(open))}}
document.querySelectorAll(".nav-trigger").forEach(btn=>btn.addEventListener("click",e=>{if(innerWidth<=900){e.preventDefault();btn.parentElement.classList.toggle("open")}}));
document.querySelectorAll(".nav a").forEach(a=>a.addEventListener("click",()=>{if(innerWidth<=900){mainNav.classList.remove("open");menuToggle?.setAttribute("aria-expanded","false")}}));
const i18nObserver=new MutationObserver(muts=>{if(currentLang!=="en")return;for(const m of muts)for(const n of m.addedNodes)if(n.nodeType===1||n.nodeType===3)translateTree(n.nodeType===1?n:n.parentElement)});
...
async function loadMe(){
  ...
  accountBtn.textContent=state.user?(state.user.full_name||state.user.email):(currentLang==="en"?"Sign in":"Đăng nhập");
}
...
function hero(){
  return `<section class="hero">
    <div class="hero-copy"><span class="pill white">SKY FIRST NETWORK • SFN</span>
      <h1>${E(currentLang==="en"?"Connecting education. Advancing communities.":(state.config?.hero_title||"Kết nối giáo dục. Phát triển cộng đồng."))}</h1>
      <p>${E(currentLang==="en"?"A unified platform for Members, Core Team, Volunteers, Students/Learners, classes, activities, applications, certificates and Sky First Network administration.":(state.config?.hero_text||"Một cổng chung cho Thành viên, Core Team, Tình nguyện viên, Học sinh/Học viên, lớp học, hoạt động, hồ sơ, GCN/GXN và quản trị Sky First Network."))}</p>
      <p><b>${E(currentLang==="en"?"Connect knowledge – Share values – Shape the future.":(state.config?.slogan||"Kết nối tri thức – Lan tỏa giá trị – Kiến tạo tương lai."))}</b></p>
      <div class="actions"><a class="primary" href="#forms">Đăng ký tham gia</a><a class="secondary" href="#login">Đăng nhập hệ thống</a></div>
    </div>
  </section>`;
}
async function renderHome(){
  app.innerHTML=hero()+`<h2 class="section-title">Truy cập nhanh</h2>
  <div class="grid4">
   ${quickCard("users","Thành viên & Core Team","Đăng ký và theo dõi hồ sơ nhân sự.","#forms")}
   ${quickCard("heart","Tình nguyện viên","TNV chung và TNV dạy học theo phạm vi chuyên môn.","#form/volunteer")}
   ${quickCard("book","Lớp học SFEC","Lớp 9–12, Cơ bản, Giao tiếp, IELTS.","#classes")}
   ${quickCard("badge","GCN & GXN","Tra cứu giấy chứng nhận/giấy xác nhận.","#lookup")}
  </div><h2 class="section-title">Tin mới</h2><div class="grid" id="homeNews"></div>`;
  try{
    const d=await api("/api/public/news");
    document.getElementById("homeNews").innerHTML=(d.items||[]).slice(0,3).map(newsCard).join("")||`<div class="card muted">Chưa có tin.</div>`;
  }catch{}
}
function lineIcon(name){const paths={users:'<path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75"/>',heart:'<path d="M20.8 4.6a5.5 5.5 0 0 0-7.8 0L12 5.6l-1-1a5.5 5.5 0 0 0-7.8 7.8l1 1L12 21l7.8-7.6 1-1a5.5 5.5 0 0 0 0-7.8z"/>',book:'<path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/>',badge:'<circle cx="12" cy="8" r="6"/><path d="M8.2 13 7 22l5-3 5 3-1.2-9"/>'};return `<div class="quick-icon"><svg viewBox="0 0 24 24" aria-hidden="true">${paths[name]||paths.book}</svg></div>`}
...
async function renderUnits(){
  const d=await api("/api/public/units");app.innerHTML=`<h1>Đơn vị trực thuộc</h1><div class="grid">${(d.items||[]).map(u=>`<div class="card"><span class="pill">${E(u.code)}</span><h3>${E(u.name)}</h3><p>${E(u.unit_type||"")}</p><p class="muted">Phụ trách: ${E(u.manager_name||"—")}<br>${E(u.email||"")}</p><span class="status">${E(u.status)}</span></div>`).join("")}</div>`;
}
...
function renderLogin(){
  ...
  <div class="role-grid">
   <button class="role-card" onclick="showLogin('student')"><div class="role-mark">S</div><h3>Bạn là Học sinh/Học viên?</h3><p class="muted">Lớp học, hồ sơ, thông báo, GCN/GXN.</p></button>
   <button class="role-card" onclick="showLogin('member')"><div class="role-mark">M</div><h3>Bạn là Thành viên?</h3><p class="muted">Hồ sơ nhân sự, hoạt động, nhiệm vụ và thủ tục nội bộ.</p></button>
   <button class="role-card" onclick="showLogin('admin')"><div class="role-mark">A</div><h3>Bạn là Quản trị viên?</h3><p class="muted">Chỉ tài khoản đã được cấp quyền quản trị.</p></button>
...
const adminMenu=[
 ...
 ["submissions","Hồ sơ đăng ký"],
 ["users","Tài khoản & Phân quyền"],
 ["people","Hồ sơ nhân sự"],
 ["recruitment","Tuyển dụng & Đánh giá"],
 ["forms","Form Builder"],
 ["terms","Điều khoản & Chính sách"],
 ["teaching","Phạm vi TNV Dạy học"],
 ["classes","Lớp học & Điểm danh"],
 ["events","Sự kiện & Check-in"],
 ["certificates","GCN & GXN"],
 ["documents","Kho văn bản"],
 ["units","Đơn vị trực thuộc"],
 ["news","Tin tức & CMS"],
 ["tickets","Hỗ trợ & Ticket"],
 ["privacy","Quyền riêng tư"],
 ["files","File & Minh chứng"],
 ["tasks","Nhiệm vụ"],
 ["email","Email"],
 ["modules","Modules"],
 ["settings","Cài đặt"],
...
async function adminDashboard(main){
  ...
  main.innerHTML=`<h1>Quản trị SFN</h1><div class="kpis"><div class="kpi"><b>${c.submissions}</b>Hồ sơ</div><div class="kpi"><b>${c.pending}</b>Cần xử lý</div><div class="kpi"><b>${c.people}</b>Nhân sự</div><div class="kpi"><b>${c.certificates}</b>GCN/GXN đã cấp</div><div class="kpi"><b>${c.approvals}</b>Chờ phê duyệt</div><div class="kpi"><b>${c.tickets}</b>Ticket mở</div><div class="kpi"><b>${c.tasks}</b>Nhiệm vụ</div></div>
  <div class="card" style="margin-top:14px"><h2>Nguyên tắc phân quyền</h2><p>Super Admin gốc: <b>skyfirst.ec@gmail.com</b>. Thành viên không tự cấp quyền. Quản trị viên chỉ cấp được vai trò trong phạm vi thẩm quyền.</p></div>`;
}
