...
SET subject_template='Sky First | Xác nhận đăng ký {{APPLICATION_ID}}',
...
<div style="margin-top:11px;font-size:11px;opacity:.75;">© 2026 Sky First Network. All rights reserved.</div>
    ...
    text_template='Xin chào {{FULL_NAME}},\nThông tin đăng ký của bạn đã được tiếp nhận.\nMã đăng ký: {{APPLICATION_ID}}\nLoại đăng ký: {{APPLICATION_TYPE}}\nTrạng thái: {{STATUS}}\nTra cứu: https://ctt.skyfirst.io.vn/#lookup\n\nLưu ý: Đây là email tự động. Vui lòng không phản hồi trực tiếp email này.',
    enabled=1,
