...
| network_secretary | 80 | Phê duyệt nghiệp vụ/GCN theo thẩm quyền |
...
- Quyền `member`, `volunteer`, Admin phải do SFN cấp.
...
- Tài khoản gốc `skyfirst.ec@gmail.com` không thể bị Admin khác khóa hoặc gỡ quyền Super Admin.
