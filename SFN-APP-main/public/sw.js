const CACHE='sfn-shell-2026-08';
const SHELL=['/','/index.html','/styles.css','/app.js','/manifest.webmanifest','/assets/sfn-logo.png','/assets/sfn-cover.png','/assets/sfn-wordmark.png'];
