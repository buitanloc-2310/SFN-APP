...
async function renderHome(){
  ...
  <section class="system-hub">
    <div class="section-heading"><div><span class="eyebrow">HỆ SINH THÁI SKY FIRST</span><h2>Các cổng kết nối</h2><p class="muted">Truy cập nhanh các nền tảng trong hệ sinh thái. Mỗi cổng phục vụ một nhóm nghiệp vụ riêng nhưng cùng nhận diện Sky First Network.</p></div></div>
    <div class="portal-grid">
      ${portalCard("Sky First Network","Cổng thông tin chính của mạng lưới.","https://skyfirst.io.vn","Cổng chính")}
      ${portalCard("Tình nguyện viên","Đăng ký, hồ sơ và hoạt động tình nguyện.","https://tnv.skyfirst.io.vn","TNV")}
      ${portalCard("SFEC","Cổng thông tin The Sky First English Club.","https://ctt.sfec.skyfirst.io.vn","Tiếng Anh")}
      ${portalCard("Nhà Hán Ngữ","Cổng thông tin và xác thực của Nhà Hán Ngữ.","https://ctt.nhahanngu.io.vn","Hán ngữ")}
    </div>
  </section>
  <h2 class="section-title">Tin mới</h2><div class="grid" id="homeNews"></div>`;
  try{
